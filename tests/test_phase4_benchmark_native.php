<?php
// PHASE 4 Performance Benchmark: Functions (Native PHP with timing)
...
echo "Native PHP - Phase 4 Functions Benchmark\n";
echo "=========================================\n";
...
echo "  - 100 recursive calls (fib(15) = " . fib(15) . ")\n";
echo "\n";
echo "Execution Time: " . number_format($elapsed, 3) . "ms\n";
echo "Throughput: " . number_format(30100 / $elapsed * 1000, 0) . " ops/second\n";
?>
